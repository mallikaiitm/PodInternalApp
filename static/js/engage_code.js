...
window.onload = function (e) {
  ...
  if (
    !KTCookie2.get(page) ||
    (KTCookie2.get(page) && !KTCookie2.get(page + "_2"))
  ) {
    var metronic8Engage = document.createElement("div");

    metronic8Engage.setAttribute(
      "style",
      "transform: translateX(-50%); position: fixed; z-index: 10000; max-width: 1300px; width: 100%; margin: 0 30px; left: 50%; bottom: 60px; background-color: #050421; padding: 20px; border-radius: 6px; box-shadow: 0px 5px 30px rgba(5, 4, 33, 0.3); display: flex; align-items: center; justify-content: space-between;"
    );
    ...
    setTimeout(function () {
      ...
      document
        .querySelector("#kt_metronic_8_engage_dismiss")
        .addEventListener("click", function (e) {
          ...
          KTCookie2.set(page, "1", {
            expires: new Date(date.getTime() + time3days),
          });
          KTCookie2.set(page + "_2", "1", {
